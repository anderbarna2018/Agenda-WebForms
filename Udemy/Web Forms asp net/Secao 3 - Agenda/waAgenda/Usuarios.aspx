<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePrincipal.master" AutoEventWireup="true" CodeFile="Usuarios.aspx.cs" Inherits="Usuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSourceUsuarios" DataKeyNames="email" InsertItemPosition="LastItem">
        ...
        <InsertItemTemplate>
            <tr style="">
                ...
                <td>
                    <asp:TextBox ID="txtNomeInsert" runat="server" Text='<%# Bind("nome") %>' />
                </td>
                <td>
                    <asp:TextBox ID="txtEmailInsert" runat="server" Text='<%# Bind("email") %>' />
                </td>
                <td>
                    <asp:TextBox ID="txtSenhaInsert" runat="server" Text='<%# Bind("senha") %>' />
                </td>
            </tr>
        </InsertItemTemplate>
        <ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSourceUsuarios" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [usuario] WHERE [email] = @email" InsertCommand="INSERT INTO [usuario] ([nome], [email], [senha]) VALUES (@nome, @email, @senha)" SelectCommand="SELECT [nome], [email], [senha] FROM [usuario]" UpdateCommand="UPDATE [usuario] SET [nome] = @nome, [senha] = @senha WHERE [email] = @email" OnInserted="SqlDataSourceUsuarios_Inserted" OnUpdated="SqlDataSourceUsuarios_Inserted" >
        <DeleteParameters>
