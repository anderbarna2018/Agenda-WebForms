<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListViewaspx.aspx.cs" Inherits="ListViewaspx" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSourceAgenda" InsertItemPosition="LastItem">
                <AlternatingItemTemplate>
                    <tr style="background-color:#FFF8DC;">
                        <td>
                            <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Excluir" />
                            <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="Alterar" />
                        </td>
                        <td>
            ...
            <br />
            <br />
            <asp:Label ID="lbTeste" runat="server" Text="Label"></asp:Label>
        </div>
    </form>
</body>
</html>
